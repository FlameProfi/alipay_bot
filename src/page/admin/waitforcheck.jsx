...
const WaitForCheck = () => {
    ...
    const navigate = useNavigate();
		...
		const filteredUsers = accounts.filter(account => account.status == "На проверке", )
    ...
    return (
        <div className={'admin_content'}>
					<div className={'items'}> 
						...
						<button onClick={() => navigate('/admin_accounts')}>Залитые</button>
